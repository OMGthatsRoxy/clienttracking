...
export default function ScheduleColumnTestPage() {
  ...
  const getWeekDates = () => {
    ...
    const daysToMonday = dayOfWeek === 0 ? 6 : dayOfWeek - 1; // 计算到周一的距离
        ...
        <div style={{ 
          ...
          <div style={{ overflowX: 'auto', position: 'relative' }}>
            ...
            {currentDates.map((date: string, dateIndex: number) => {
              ...
              console.log(`测试 - 日期 ${date} (索引 ${dateIndex}):`, {
        ...
        <div style={{ 
          ...
          <div style={{ color: '#a1a1aa', lineHeight: 1.6 }}>
            ...
            <ul style={{ marginBottom: '16px' }}>
              <li>验证课程块是否显示在正确的日期列中</li>
              <li>检查每个日期列的定位计算是否正确</li>
              <li>确认课程块的时间定位是否准确</li>
            </ul>
            
            <h3 style={{ color: '#fff', marginBottom: '8px' }}>📊 测试数据：</h3>
            <ul>
              <li>周一：张三 9:30-10:30（蓝色）</li>
              <li>周二：李四 11:00-12:00（绿色）</li>
              <li>周三：王五 14:30-15:30（红色）</li>
              <li>周四：赵六 16:00-17:00（蓝色）</li>
            </ul>
